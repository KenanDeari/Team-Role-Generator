...
function startingPrompt() {
    inquirer.prompt([
        {
            message: "Welcome to a Quick & Simple Team Generator! Please write your team's desired name.",
            name: "teamname"
        }
    ])
        .then(function (data) {
...
// added prompt to ask if user would like to add more team members
...
function compileTeam() {
    console.log("You've completed your team profile. A new HTML file has now been generated.")
